...
namespace GeoHashCSharp.Common.Util
{
    public static class Constants
    {
        ...
        public static readonly double METERS_PER_DEGREE_LATITUDE = 110574;

        // The equatorial circumference of the earth in meters
        public static readonly double EARTH_MERIDIONAL_CIRCUMFERENCE = 40007860;

        // The equatorial radius of the earth in meters
        public static readonly double EARTH_EQ_RADIUS = 6378137;

        // The meridional radius of the earth in meters
        public static readonly double EARTH_POLAR_RADIUS = 6357852.3;
         ...
         */
        public static readonly double EARTH_E2 = 0.00669447819799;
